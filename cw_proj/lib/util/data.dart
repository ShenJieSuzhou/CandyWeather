...
List jiTangData = [
  {"name":"白鹤林《孤独》","data":"从童年起，我便独自一人,照顾着,历代的星辰。"},
  {"name":"安德鲁•怀斯《远方》","data":"于是整整一个雨季，我守着阳光，守着越冬的麦田，将那段闪亮的日子，轻轻弹唱。"},
  {"name":"安德鲁•怀斯《远方》","data":"你在风口遥望彼岸的紫丁香，你在田野捡拾古老的忧伤，我知道那是你心的方向。"},
  {"name":"顾城《门前》","data":"草在结它的种子，风在摇它的叶子。我们站着，不说话，就十分美好。"},
  {"name":"顾城《远和近》","data":"你，一会看我，一会看云。我觉得，你看我时很远，你看云时很近。"},
];
